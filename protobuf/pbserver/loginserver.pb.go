...
type LoginKeyVerifyUpdateReq struct {
	OpenId string `protobuf:"bytes,1,opt,name=openId,proto3" json:"openId,omitempty"`
}

func (m *LoginKeyVerifyUpdateReq) Reset()         { *m = LoginKeyVerifyUpdateReq{} }
func (m *LoginKeyVerifyUpdateReq) String() string { return proto.CompactTextString(m) }
func (*LoginKeyVerifyUpdateReq) ProtoMessage()    {}
func (*LoginKeyVerifyUpdateReq) Descriptor() ([]byte, []int) {
	return fileDescriptorLoginserver, []int{2}
}

func (m *LoginKeyVerifyUpdateReq) GetOpenId() string {
	if m != nil {
		return m.OpenId
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*LoginKeyVerifyUpdateReq)(nil), "pbserver.LoginKeyVerifyUpdateReq")
}
...
func (m *LoginKeyVerifyUpdateReq) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *LoginKeyVerifyUpdateReq) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *LoginKeyVerifyUpdateReq) Size() (n int) {
	var l int
	_ = l
	l = len(m.OpenId)
	if l > 0 {
...
func (m *LoginKeyVerifyUpdateReq) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LoginKeyVerifyUpdateReq: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LoginKeyVerifyUpdateReq: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorLoginserver = []byte{
	...
	0x19, 0x89, 0x79, 0x79, 0xa9, 0x39, 0x60, 0xdb, 0x59, 0x83, 0x60, 0x5c, 0x25, 0x43, 0x2e, 0x71,
	0x54, 0x63, 0x42, 0x0b, 0x52, 0x12, 0x4b, 0x52, 0xf1, 0xf8, 0xc4, 0x49, 0xe0, 0xc4, 0x23, 0x39,
	0xc6, 0x0b, 0x8f, 0xe4, 0x18, 0x1f, 0x3c, 0x92, 0x63, 0x9c, 0xf1, 0x58, 0x8e, 0x21, 0x89, 0x0d,
	0x1c, 0x32, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xd1, 0x1d, 0xe5, 0x78, 0x2e, 0x01, 0x00,
	0x00,
}
