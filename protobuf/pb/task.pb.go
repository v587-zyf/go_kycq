...
type SetTaskInfoReq struct {
	TaskId  int32 `protobuf:"varint,1,opt,name=taskId,proto3" json:"taskId,omitempty"`
	Process int32 `protobuf:"varint,2,opt,name=process,proto3" json:"process,omitempty"`
}

func (m *SetTaskInfoReq) Reset()                    { *m = SetTaskInfoReq{} }
func (m *SetTaskInfoReq) String() string            { return proto.CompactTextString(m) }
func (*SetTaskInfoReq) ProtoMessage()               {}
func (*SetTaskInfoReq) Descriptor() ([]byte, []int) { return fileDescriptorTask, []int{4} }

func (m *SetTaskInfoReq) GetTaskId() int32 {
	if m != nil {
		return m.TaskId
	}
	return 0
...
func (m *SetTaskInfoReq) GetProcess() int32 {
	if m != nil {
		return m.Process
	}
	return 0
...
type SetTaskInfoAck struct {
	TaskId  int32 `protobuf:"varint,1,opt,name=taskId,proto3" json:"taskId,omitempty"`
	Process int32 `protobuf:"varint,2,opt,name=process,proto3" json:"process,omitempty"`
}

func (m *SetTaskInfoAck) Reset()                    { *m = SetTaskInfoAck{} }
func (m *SetTaskInfoAck) String() string            { return proto.CompactTextString(m) }
func (*SetTaskInfoAck) ProtoMessage()               {}
func (*SetTaskInfoAck) Descriptor() ([]byte, []int) { return fileDescriptorTask, []int{5} }

func (m *SetTaskInfoAck) GetTaskId() int32 {
	if m != nil {
		return m.TaskId
	}
	return 0
...
func (m *SetTaskInfoAck) GetProcess() int32 {
	if m != nil {
		return m.Process
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*SetTaskInfoReq)(nil), "pb.SetTaskInfoReq")
	proto.RegisterType((*SetTaskInfoAck)(nil), "pb.SetTaskInfoAck")
}
...
func (m *SetTaskInfoReq) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *SetTaskInfoReq) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *SetTaskInfoAck) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *SetTaskInfoAck) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *SetTaskInfoReq) Size() (n int) {
	var l int
	_ = l
	if m.TaskId != 0 {
		n += 1 + sovTask(uint64(m.TaskId))
...
func (m *SetTaskInfoAck) Size() (n int) {
	var l int
	_ = l
	if m.TaskId != 0 {
		n += 1 + sovTask(uint64(m.TaskId))
...
func (m *SetTaskInfoReq) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SetTaskInfoReq: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SetTaskInfoReq: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *SetTaskInfoAck) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SetTaskInfoAck: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SetTaskInfoAck: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
var fileDescriptorTask = []byte{
	...
	0x04, 0x96, 0x80, 0x71, 0x95, 0x9c, 0xb8, 0xf8, 0x82, 0x53, 0x4b, 0x40, 0xe6, 0x78, 0xe6, 0xa5,
	0xe5, 0xe3, 0x71, 0x3a, 0xd1, 0x66, 0x90, 0xe5, 0x0e, 0x27, 0x81, 0x13, 0x8f, 0xe4, 0x18, 0x2f,
	0x3c, 0x92, 0x63, 0x7c, 0xf0, 0x48, 0x8e, 0x71, 0xc6, 0x63, 0x39, 0x86, 0x24, 0x36, 0x70, 0xc0,
	0x1a, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xc8, 0x3c, 0x69, 0x80, 0x78, 0x01, 0x00, 0x00,
}
