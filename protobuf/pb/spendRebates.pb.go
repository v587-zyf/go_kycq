...
func (m *SpendRebatesNtf) GetCycle() int32 {
	if m != nil {
		return m.Cycle
	}
	return 0
...
func (m *SpendRebatesNtf) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Cycle != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintSpendRebates(dAtA, i, uint64(m.Cycle))
	}
	return i, nil
}
...
func (m *SpendRebatesNtf) Size() (n int) {
	...
	if m.Cycle != 0 {
		n += 1 + sovSpendRebates(uint64(m.Cycle))
	}
	return n
}
...
var fileDescriptorSpendRebates = []byte{
	...
	0x31, 0x2f, 0x3d, 0xd5, 0xaf, 0x24, 0x2d, 0x08, 0xa2, 0x40, 0x29, 0x96, 0x8b, 0x1f, 0xd9, 0x48,
	...
	0x03, 0x12, 0x4d, 0xae, 0x4c, 0xce, 0x49, 0x95, 0x60, 0x86, 0x88, 0x82, 0x39, 0x4e, 0x02, 0x27,
	0x1e, 0xc9, 0x31, 0x5e, 0x78, 0x24, 0xc7, 0xf8, 0xe0, 0x91, 0x1c, 0xe3, 0x8c, 0xc7, 0x72, 0x0c,
	0x49, 0x6c, 0x60, 0x3f, 0x1b, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x7b, 0x83, 0xa0, 0x0e, 0x1b,
	0x01, 0x00, 0x00,
}
