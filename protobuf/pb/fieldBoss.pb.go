...
type EnterFieldBossFightAck struct {
	StageId int32 `protobuf:"varint,1,opt,name=stageId,proto3" json:"stageId,omitempty"`
	DareNum int32 `protobuf:"varint,2,opt,name=dareNum,proto3" json:"dareNum,omitempty"`
}

func (m *EnterFieldBossFightAck) Reset()                    { *m = EnterFieldBossFightAck{} }
func (m *EnterFieldBossFightAck) String() string            { return proto.CompactTextString(m) }
func (*EnterFieldBossFightAck) ProtoMessage()               {}
func (*EnterFieldBossFightAck) Descriptor() ([]byte, []int) { return fileDescriptorFieldBoss, []int{3} }

func (m *EnterFieldBossFightAck) GetStageId() int32 {
	if m != nil {
		return m.StageId
	}
	return 0
...
func (m *EnterFieldBossFightAck) GetDareNum() int32 {
	if m != nil {
		return m.DareNum
	}
	return 0
...
func (*FieldBossFightResultNtf) Descriptor() ([]byte, []int) { return fileDescriptorFieldBoss, []int{4} }
...
func (*FieldBossBuyNumReq) Descriptor() ([]byte, []int) { return fileDescriptorFieldBoss, []int{5} }
...
func (m *FieldBossBuyNumReq) GetBuyNum() int32 {
	if m != nil {
		return m.BuyNum
	}
	return 0
...
func (*FieldBossBuyNumAck) Descriptor() ([]byte, []int) { return fileDescriptorFieldBoss, []int{6} }
...
// 领取首次奖励
type FieldBossFirstReq struct {
}

func (m *FieldBossFirstReq) Reset()                    { *m = FieldBossFirstReq{} }
func (m *FieldBossFirstReq) String() string            { return proto.CompactTextString(m) }
func (*FieldBossFirstReq) ProtoMessage()               {}
func (*FieldBossFirstReq) Descriptor() ([]byte, []int) { return fileDescriptorFieldBoss, []int{7} }

type FieldBossFirstAck struct {
	FirstReceive bool            `protobuf:"varint,1,opt,name=firstReceive,proto3" json:"firstReceive,omitempty"`
	Goods        *GoodsChangeNtf `protobuf:"bytes,2,opt,name=goods" json:"goods,omitempty"`
}

func (m *FieldBossFirstAck) Reset()                    { *m = FieldBossFirstAck{} }
func (m *FieldBossFirstAck) String() string            { return proto.CompactTextString(m) }
func (*FieldBossFirstAck) ProtoMessage()               {}
func (*FieldBossFirstAck) Descriptor() ([]byte, []int) { return fileDescriptorFieldBoss, []int{8} }

func (m *FieldBossFirstAck) GetFirstReceive() bool {
	if m != nil {
...
func (m *FieldBossFirstAck) GetGoods() *GoodsChangeNtf {
	if m != nil {
		return m.Goods
	}
	return nil
...
func (*FieldBossNtf) Descriptor() ([]byte, []int) { return fileDescriptorFieldBoss, []int{9} }
...
func init() {
	...
	proto.RegisterType((*EnterFieldBossFightAck)(nil), "pb.EnterFieldBossFightAck")
	...
	proto.RegisterType((*FieldBossFirstReq)(nil), "pb.FieldBossFirstReq")
	proto.RegisterType((*FieldBossFirstAck)(nil), "pb.FieldBossFirstAck")
...
func (m *EnterFieldBossFightAck) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *EnterFieldBossFightAck) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *FieldBossFirstReq) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *FieldBossFirstReq) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *FieldBossFirstAck) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *FieldBossFirstAck) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *EnterFieldBossFightAck) Size() (n int) {
	var l int
	_ = l
	if m.StageId != 0 {
		n += 1 + sovFieldBoss(uint64(m.StageId))
...
func (m *FieldBossFirstReq) Size() (n int) {
	var l int
	_ = l
	return n
}

func (m *FieldBossFirstAck) Size() (n int) {
	var l int
	_ = l
	if m.FirstReceive {
		n += 2
...
func (m *EnterFieldBossFightAck) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EnterFieldBossFightAck: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EnterFieldBossFightAck: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *FieldBossFirstReq) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FieldBossFirstReq: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FieldBossFirstReq: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *FieldBossFirstAck) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FieldBossFirstAck: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FieldBossFirstAck: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
var fileDescriptorFieldBoss = []byte{
	...
	,
}
