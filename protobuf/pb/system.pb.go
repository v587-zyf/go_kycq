...
type FuncStateCloseNtf struct {
	CloseFuncId []int32 `protobuf:"varint,1,rep,packed,name=closeFuncId" json:"closeFuncId,omitempty"`
}

func (m *FuncStateCloseNtf) Reset()                    { *m = FuncStateCloseNtf{} }
func (m *FuncStateCloseNtf) String() string            { return proto.CompactTextString(m) }
func (*FuncStateCloseNtf) ProtoMessage()               {}
func (*FuncStateCloseNtf) Descriptor() ([]byte, []int) { return fileDescriptorSystem, []int{6} }

func (m *FuncStateCloseNtf) GetCloseFuncId() []int32 {
	if m != nil {
		return m.CloseFuncId
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*FuncStateCloseNtf)(nil), "pb.FuncStateCloseNtf")
}
...
func (m *FuncStateCloseNtf) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *FuncStateCloseNtf) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.CloseFuncId) > 0 {
		dAtA2 := make([]byte, len(m.CloseFuncId)*10)
		var j1 int
		for _, num1 := range m.CloseFuncId {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *FuncStateCloseNtf) Size() (n int) {
	var l int
	_ = l
	if len(m.CloseFuncId) > 0 {
		l = 0
		for _, e := range m.CloseFuncId {
...
func (m *FuncStateCloseNtf) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FuncStateCloseNtf: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FuncStateCloseNtf: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType == 0 {
				...
				m.CloseFuncId = append(m.CloseFuncId, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field CloseFuncId", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipSystem(dAtA[iNdEx:])
...
var fileDescriptorSystem = []byte{
	...
	0x4c, 0x25, 0xc5, 0x60, 0x05, 0xcc, 0x41, 0x4c, 0x25, 0xc5, 0x4a, 0x4e, 0x5c, 0x02, 0x01, 0x45,
	...
	0x9f, 0xfc, 0xc4, 0x94, 0xa0, 0xd4, 0x42, 0x25, 0x67, 0x74, 0x41, 0x72, 0x4c, 0x36, 0xe5, 0x12,
	0x74, 0x2b, 0xcd, 0x4b, 0x0e, 0x2e, 0x49, 0x2c, 0x49, 0x75, 0xce, 0xc9, 0x2f, 0x4e, 0xf5, 0x2b,
	0x49, 0x13, 0x52, 0xe0, 0xe2, 0x4e, 0x06, 0xb1, 0x41, 0x32, 0x9e, 0x29, 0x60, 0x53, 0x58, 0x83,
	0x90, 0x85, 0x9c, 0x04, 0x4e, 0x3c, 0x92, 0x63, 0xbc, 0xf0, 0x48, 0x8e, 0xf1, 0xc1, 0x23, 0x39,
	0xc6, 0x19, 0x8f, 0xe5, 0x18, 0x92, 0xd8, 0xc0, 0x61, 0x6e, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff,
	0x53, 0xd6, 0xb5, 0x7b, 0x95, 0x01, 0x00, 0x00,
}
