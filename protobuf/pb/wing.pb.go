...
func (m *WingSpecialUpReq) GetSpecialType() int32 {
	if m != nil {
...
func (m *WingSpecialUpReq) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SpecialType != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintWing(dAtA, i, uint64(m.SpecialType))
	}
	return i, nil
}
...
func (m *WingSpecialUpReq) Size() (n int) {
	...
	if m.SpecialType != 0 {
		n += 1 + sovWing(uint64(m.SpecialType))
	}
	return n
}
...
var fileDescriptorWing = []byte{
	...
	,
}
