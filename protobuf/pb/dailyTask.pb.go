...
type ResourcesBackGetRewardReq struct {
	...
	UseIngot   int32 `protobuf:"varint,3,opt,name=useIngot,proto3" json:"useIngot,omitempty"`
}
...
func (m *ResourcesBackGetRewardReq) GetUseIngot() int32 {
	if m != nil {
		return m.UseIngot
	}
	return 0
...
type ResourcesBackGetAllRewardReq struct {
}

func (m *ResourcesBackGetAllRewardReq) Reset()         { *m = ResourcesBackGetAllRewardReq{} }
func (m *ResourcesBackGetAllRewardReq) String() string { return proto.CompactTextString(m) }
func (*ResourcesBackGetAllRewardReq) ProtoMessage()    {}
func (*ResourcesBackGetAllRewardReq) Descriptor() ([]byte, []int) {
	return fileDescriptorDailyTask, []int{10}
}

type ResourcesBackGetAllRewardAck struct {
	ResourcesBackInfos  []*ResourcesBackInfo `protobuf:"bytes,1,rep,name=ResourcesBackInfos" json:"ResourcesBackInfos,omitempty"`
	DayResourcesBackExp int32                `protobuf:"varint,2,opt,name=dayResourcesBackExp,proto3" json:"dayResourcesBackExp,omitempty"`
}

func (m *ResourcesBackGetAllRewardAck) Reset()         { *m = ResourcesBackGetAllRewardAck{} }
func (m *ResourcesBackGetAllRewardAck) String() string { return proto.CompactTextString(m) }
func (*ResourcesBackGetAllRewardAck) ProtoMessage()    {}
func (*ResourcesBackGetAllRewardAck) Descriptor() ([]byte, []int) {
	return fileDescriptorDailyTask, []int{11}
}

func (m *ResourcesBackGetAllRewardAck) GetResourcesBackInfos() []*ResourcesBackInfo {
	if m != nil {
		return m.ResourcesBackInfos
	}
	return nil
...
func (m *ResourcesBackGetAllRewardAck) GetDayResourcesBackExp() int32 {
	if m != nil {
		return m.DayResourcesBackExp
	}
	return 0
...
func (*HaveChallengeTime) Descriptor() ([]byte, []int) { return fileDescriptorDailyTask, []int{12} }
...
func (*ResourcesBackInfo) Descriptor() ([]byte, []int) { return fileDescriptorDailyTask, []int{13} }
...
func init() {
	...
	proto.RegisterType((*ResourcesBackGetAllRewardReq)(nil), "pb.ResourcesBackGetAllRewardReq")
	proto.RegisterType((*ResourcesBackGetAllRewardAck)(nil), "pb.ResourcesBackGetAllRewardAck")
...
func (m *ResourcesBackGetRewardReq) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UseIngot != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintDailyTask(dAtA, i, uint64(m.UseIngot))
	}
	return i, nil
}
...
func (m *ResourcesBackGetAllRewardReq) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ResourcesBackGetAllRewardReq) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ResourcesBackGetAllRewardAck) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ResourcesBackGetAllRewardAck) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ResourcesBackGetRewardReq) Size() (n int) {
	...
	if m.UseIngot != 0 {
		n += 1 + sovDailyTask(uint64(m.UseIngot))
	}
	return n
}
...
func (m *ResourcesBackGetAllRewardReq) Size() (n int) {
	var l int
	_ = l
	return n
}

func (m *ResourcesBackGetAllRewardAck) Size() (n int) {
	var l int
	_ = l
	if len(m.ResourcesBackInfos) > 0 {
		for _, e := range m.ResourcesBackInfos {
...
func (m *ResourcesBackGetRewardReq) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UseIngot", wireType)
			}
			m.UseIngot = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *ResourcesBackGetAllRewardReq) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResourcesBackGetAllRewardReq: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResourcesBackGetAllRewardReq: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *ResourcesBackGetAllRewardAck) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResourcesBackGetAllRewardAck: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResourcesBackGetAllRewardAck: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorDailyTask = []byte{
	...
	,
}
